...
function renderLegal(kind: 'privacy' | 'terms'): void {
  ...
  setPageMeta(`${isPrivacy ? 'Privacy' : 'Terms'} — Kindred Co-op`, isPrivacy ? 'How temporary rooms, browser storage, page counts, and licenses are handled.' : 'Terms for the free puzzle and one-time family game license.', isPrivacy ? '/privacy' : '/terms');
